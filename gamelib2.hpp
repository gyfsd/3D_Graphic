...
class sdl_{
	...
	int sx = 300; //Window size x
	int sy = 300; //Window size y
...
class zlayer_mask_{
	...
	void fill_polygon(int *pointsx,int *pointsy,uint32_t pointsC,uint32_t col,float layer,SDL_Surface *scr){
                uint32_t point = 0;
                float sumx = 0;
                float sumy = 0;
                while(point < pointsC){
