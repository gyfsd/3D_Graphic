...
class render_{
	...
	void draw_point(point_ point,cam camd,SDL_Surface *scr){
		...
		d.circle((int)pointd.x,(int)pointd.y,2,0xffffffff,scr);}
	}
	void draw_line(point_ point,point_ topoint,cam camd,SDL_Surface *scr){
		...
		if(pointd.x > -1 & pointd.x < scr->w & pointc.y > -1 & pointc.y < scr->h & pointc.z-camd.pos.z >= 0 & pointa.z-camd.pos.z >= 0){
			if(pointb.x > -1 & pointb.x < scr->w & pointb.y > -1 & pointb.y < scr->h){
	...
	void render(points PS,cam camd,SDL_Surface *scr){
		...
		while(Psel < PS.pointsC){
			...
			//draw_line(PS.points[Psel],PS.points[PS.points[Psel].edges[Esel]],camd,scr);
			//Esel++;
			//}
			Psel++;
		}
